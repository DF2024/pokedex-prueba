    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 px-4 sm:px-8 lg:px-12 py-10 max-w-[1800px] mx-auto">
      {pokemon.map((item) => {
        ...
        return (
          <div
            key={item.id}
            onClick={() => navitage(`/details/${item.id}`)}
            ...
            <div className="mb-6 space-y-1">
              ...
              <div className="flex gap-2 flex-wrap">
                {item.types?.map((type) => (
                  <span
                    key={type}
                    className="bg-blue-700 text-white text-xs px-2 py-1 rounded shadow-inner font-black uppercase tracking-widest"
                  >
                    {type}
                  </span>
                ))}

                <span className="bg-green-700 text-white text-xs px-2 py-1 rounded shadow-inner font-black uppercase tracking-widest italic">
                  EXP {item.power}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`w-10 h-10 rounded-full shadow-[4px_4px_8px_#bebebe,-4px_-4px_8px_#ffffff] active:shadow-[inset_2px_2px_4px_#bebebe]
                  
                    ${favorite ? "bg-blue-700" : "bg-[#e0e0e0]"}
                  `
                  }
                >
                  {favorite ?
                    <svg fill="#000000" viewBox="0 0 24 24" id="thunder" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg" class="w-6 mx-auto icon flat-color">
                  ...
                  : 
                    <svg viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" fill="#000000" className="w-5 mx-auto" > <g id="SVGRepo_bgCarrier" stroke-width="0"></g> 
                      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g> 
                      <g id="SVGRepo_iconCarrier"> 
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage"> 
                          <g id="Icon-Set-Filled" sketch:type="MSLayerGroup" transform="translate(-362.000000, -1037.000000)" fill={favorite ? "#FFD700" : "#e60000"}> 
