...
// Iconos SVG hardcodeados para evitar dependencias
const Icons = {
    Heart: () => (
    ...
    // Sub-componente para los anillos de estadísticas
    ...
    return (
        ...
        // Sub-componente para tarjetas de información técnica
        ...
        // Mantenemos tu configuración exacta de STAT_CONFIG usando los SVG locales
        const STAT_CONFIG = [
        ...
        // Tu función lógica para extraer valores
